...
SDL_Color dark_tile = {16,37,66, 255};*/ // > red/gray
...
// minimal
SDL_Color light_piece = {0xff, 0xff, 0xff, 0xff};
SDL_Color dark_piece = {0,0,0, 255};

SDL_Color light_tile = {0xdf, 0xdf, 0xdf, 0xff};
SDL_Color dark_tile = {0x7b,0x7b,0x7b, 255};
